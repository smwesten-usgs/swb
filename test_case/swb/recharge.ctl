...
#
# This test case was developed as an example problem. Unlike most sites,
# this one had a weighing lysimeter and other instrumentation on site from
# the 1930s until 2012. The site is centered around the (former) North
# Appalachian Experimental Watershed (NAEW) in Coshocton, Ohio. Climate data is
# from monitoring performed by staff at the site.
#
#--------------------------------------------------------------------------
...
#*******************************************************************
# the following extracts surface runoff from the approximate
# outlet of experimental watershed 127
WRITE_SSF OUTFLOW COORDS 2166238 258732
WRITE_SSF SOIL_MOISTURE COORDS 2165215 258405
#
# The following extracts soil moisture for the approximate
# location of lysimeter 101
WRITE_SSF SOIL_MOISTURE 2 10
WRITE_SSF SOIL_MOISTURE 10 2
#*******************************************************************
