#' SWB cell class
#'
#' @param rooting_depth Rooting depth, in feet
#' @param AWC Available water capacity, in inches/foot
#' @param latitude Latitude in decimal degrees
#' @param grow_start Day of year to consider start of 'growing season'
#' @param grow_stop  Day of year to consider end of 'growing season'
#'
#' @return SWB cell object.
#' @export
#'
#' @examples
cellclass <- function(rooting_depth, AWC, latitude, grow_start, grow_stop) {
